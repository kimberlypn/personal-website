...
export default function ForbiddenIsland() {
  return (
    <p>
      ...
      My partner and I built a
      forbidden island game using the&nbsp;
      <a href="https://www2.ccs.neu.edu/javalib/ImpWorld/">ImpWorld</a>&nbsp;
      library. The user controls a pilot using the arrow keys, and the goal is
      to collect all five targets and make it to the helicopter before the
      island is completely submerged. There are three different maps that the
      user can play, the hardest one being the random terrain map, which was
      ...
      again, you can definitely expect it'd be <i>SOLID</i> improvement.
    </p>
  );
}
